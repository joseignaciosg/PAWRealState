...
public class SQLPropertyDaoTest extends DaoTest {
	...
	private void preparedao() {
		...
		final Property prop2 = new Property(Type.HOUSE, Operation.SELL,
				"BarrioNorte", "Junca 460", Integer.valueOf(500),
				Integer.valueOf(3), Integer.valueOf(100), Integer.valueOf(200),
				Integer.valueOf(5), service, "Descrip2", this.getHelper()
						.defaultUser());
	...
	public void deleteTest() {
		...
		final Services service = new Services(true, true, true, true, false,
				true);
		final Property propTrue = new Property(Type.APARTMENT, Operation.SELL,
				"Palermo", "Alem 110", Integer.valueOf(500),
				Integer.valueOf(3), Integer.valueOf(100), Integer.valueOf(200),
				Integer.valueOf(5), service, "Descrip3", this.getHelper()
						.defaultUser());

		this.propertyDao.saveOrUpdate(propTrue);

		final Property propFalse = new Property(100, Type.HOUSE,
