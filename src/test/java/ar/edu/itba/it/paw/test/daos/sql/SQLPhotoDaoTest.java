...
public class SQLPhotoDaoTest extends DaoTest {
	...
	private void preparedaos() throws IOException {
		...
		this.photo1 = new Photo(this.byteData1, "jpg", 1);
		this.photo2 = new Photo(this.byteData1, "jpg", 1);
		this.photo3 = new Photo(this.byteData1, "jpg", 2);
