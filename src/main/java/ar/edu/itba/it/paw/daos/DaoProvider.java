...
public class DaoProvider {
	...
	private static void setup() {
		...
		// final List<ContactRequest> resquests = new
		// ArrayList<ContactRequest>();
		// final List<User> users = new ArrayList<User>();
		// final List<Photo> photos = new ArrayList<Photo>();
		//
		// final Services ser1 = new Services(true, true, true, true, true,
		// true);
		...
		// "Really bad"));
		// properties.add(new Property(3, Type.HOUSE, Operation.SELL,
		// "BAlbanera",
		// "BAlbanera st. 2736", 10000, 4, 1000, 2000, 15, ser3,
		// "Excellect"));
		//
		// resquests.add(new ContactRequest(1, "Bin Laden",
		// "binladen@gmail.com",
		// "76873627", "desc1", properties.get(0)));
		// resquests.add(new ContactRequest(2, "Fredy Mercury",
		// "yanni@gmail.com",
		// "126738", "Desc2", properties.get(1)));
		// resquests.add(new ContactRequest(3, "Paco de Lucia",
		// "paco@gmail.com",
		...
		// true);
		//
		// final Property prop1 = new Property(Integer.valueOf(4),
		// Type.APARTMENT,
		...
		//
		// final Property prop4 = new Property(Integer.valueOf(7),
		// Type.APARTMENT,
		...
		propertyDao = new SQLPropertyDao(ConnectionProvider.getProvider());
		contactrequestDao = new SQLContactRequestDao(
				ConnectionProvider.getProvider());
		photoDao = new SQLPhotoDao(ConnectionProvider.getProvider());
		userDao = new SQLUserDao(ConnectionProvider.getProvider());
