...
public class RegistrationForm {
	...
	public User build() {
		if (this.type != null) {
			return new RealStateAgency(this.userName, this.lastName,
					this.email, this.phone, this.firstName, this.password,
					this.agencyName, new Photo(this.photo.getBytes(), "jpeg"));
		} else {
			return new User(this.userName, this.lastName, this.email,
					this.phone, this.firstName, this.password);
		}
	}
